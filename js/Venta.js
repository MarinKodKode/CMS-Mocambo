$(document).ready(function() {
      ...
      $.post("../controlador/ProductoController.php",{ funcion, id_producto },(response) => {
          ...
          templateCompra = `
                    <tr prodId="${json.id}" prodPrecio="${json.nombre}">
                        ...
                        <td>
                            <input type="number" min="1" class="form-control vendio_kg" value="${producto.vendio_kg}"></input>
                        </td>
                        <td>
                            <input type="number" min="1" class="form-control llevo" value="${producto.llevo}"></input>
                        </td>
                        <td>
                            <input type="number" min="1" class="form-control d_a" value="${producto.d_a}"></input>
                        </td>
                        <td class="subtotalesa">
                            <input type="number" min="1" class="form-control dev" value="${producto.dev}"></input>
                        </td>
                        <td class="subtotales">
                            <h5>0</h5>
                        </td>
    ...
    let id, precio_unitario,cantidad_kg,vendio_kg,llevo,d_a,dev, productq, productose, montos, precio;
    let piezas;
    ...
    vendio_kg = productq.querySelector(".vendio_kg").value;
    llevo = productq.querySelector(".llevo").value;
    d_a = productq.querySelector(".d_a").value;
    dev = productq.querySelector(".dev").value;
    ...
    if (recuperarLocalStorage().length == 0) {
      ...
      Swal.fire({
        ...
        registrarVenta(compra_ruta,compra_cliente,compra_capturista,compra_folio);
        Swal.fire({
            icon: "success",
    ...
    function registrarVenta(v_ruta,v_cliente,v_capturista,v_folio) {
