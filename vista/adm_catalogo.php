                  ...
                  <div class="datos_cp">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group">
                        <select name="clientes" id="clientelas" class="select2" style="width: 100%"></select>
                      </div>
                  ...
                  <table class="compra table table-hover text-nowrap">
                    <thead class='table-secondary'>
                      <tr>
                        ...
                        <th scope="col">Vendio KG</th>
                        <th scope="col">Llevo</th>
                        <th scope="col">D/A</th>
                        <th scope="col">Dev</th>
                  ...
                  <div class=" card bg bg-light pl-5 pr-5 pt-2">
                    <div class="info-box mb-3 bg-info">
                      ...
                      <div class="info-box-content">
                        ...
                        <input type="text" id="adicional_compra" value="Información adicional" class="form-control">
                      </div>
                    </div>
                  </div>
